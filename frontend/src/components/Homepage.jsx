...
//             <div className="mb-10">
//                 <h1 className="text-4xl font-bold text-primary mb-4">Welcome to GolfConnect</h1>
//                 <p className="text-lg text-text-light mb-8">Find golf matches, connect with other players, and share your golf experiences.</p>
//
...
//                         GolfConnect helps you find golf partners, organize matches, and share your golf journey with a community of passionate golfers.
//                     </p>
//
//                     <Link to="/feed" className="btn-primary inline-block mb-4 mx-2">
//                         Explore Feed
//                     </Link>
//                     <Link to="/match-management" className="btn-secondary inline-block mb-4 mx-2">
//                         Find Matches
//                     </Link>
//                 </div>
//             </div>
...
//                         </svg>
//                     </div>
//                     <h2 className="text-xl font-semibold mb-2">Find Golf Partners</h2>
//                     <p className="text-text-light">Connect with golfers in your area and never play alone again.</p>
//                 </div>
//
//                 <div className="card text-center p-6">
//                     <div className="flex justify-center mb-4">
...
//                         </svg>
//                     </div>
//                     <h2 className="text-xl font-semibold mb-2">Organize Matches</h2>
//                     <p className="text-text-light">Create and join golf matches at your favorite courses.</p>
//                 </div>
//
//                 <div className="card text-center p-6">
//                     <div className="flex justify-center mb-4">
...
//                         </svg>
//                     </div>
//                     <h2 className="text-xl font-semibold mb-2">Share Experiences</h2>
//                     <p className="text-text-light">Post photos and stories from your golf rounds.</p>
//                 </div>
//             </div>
//         </div>
//     );
