...
const FeedPost = ({
    ...
    return (
        <div className="bg-white rounded-xl shadow-lg overflow-hidden border-2 border-green-100 transition-all duration-300 ease-in-out hover:shadow-xl relative">
            {/* 포스트 헤더 */}
            <div className="flex items-center p-4 bg-gradient-to-r from-green-50 to-white cursor-pointer hover:bg-green-100/30 transition" onClick={handleProfileClick}>
                <div className="relative w-14 h-14 rounded-full bg-green-100 border-3 border-green-300 overflow-hidden flex items-center justify-center mr-4 shadow-md">
        ...
        `}
                >
                    ...
                    {!isExpanded && post.caption && post.caption.length > 100 && (
                        <div
                            className="
                    absolute
                    bottom-0
            ...
            {/* 좋아요 정보 및 인라인 좋아요 버튼 */}
            <div className="bg-green-50/50 p-4 flex items-center justify-between">
                ...
                {post.likes > 0 && (
                    <button
                        ...
                        className="text-green-700 hover:text-green-900 flex items-center text-sm transition"
                    >
            ...
            <div className="bg-green-50/30 border-t border-green-200">
                <div className="p-4">
                    <button
                        ...
                        className="w-full text-center py-3 transition-all duration-300 ease-in-out flex items-center justify-center text-green-700 font-semibold hover:text-green-900"
                    >
                        ...
                        <div className="p-4 border-t border-green-200 bg-white">
                            <form onSubmit={handleCommentSubmit} className="flex items-center">
                                ...
                                <button
                                    ...
                                    className="ml-3 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white p-3 rounded-full shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center group"
                                >
