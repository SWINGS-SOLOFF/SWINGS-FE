...
export default function JoinConfirmModal({ group, participants, onClose, onJoin }) {
    if (!group) return null;

    return (
        <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center">
            <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
                <h2 className="text-xl font-bold mb-2">{group.groupName} 참가 신청</h2>
                ...
                <div className="flex justify-end gap-2">
                    ...
                    <button onClick={onJoin} className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">
                        참여하기
                    </button>
                </div>
            </div>
